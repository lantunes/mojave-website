...
$language_data = array (
    ...
    'KEYWORDS' => array(
        ...
        51 => array (
            'ConsoleHandler', 'ErrorManager', 'FileHandler', 'Filter', 'Handler', 'Level', 'LogManager', 'LogRecord', 'LoggingMXBean', 'LoggingPermission', 'MemoryHandler', 'SimpleFormatter', 'SocketHandler', 'StreamHandler', 'XMLFormatter'
            ),
        52 => array (
        ...
        116 => array (
            ...
            'StyledEditorKit.ItalicAction', 'StyledEditorKit.StyledTextAction', 'StyledEditorKit.UnderlineAction', 'TabExpander', 'TabSet', 'TabStop', 'TabableView', 'TableView', 'TextAction', 'Utilities', 'ViewFactory', 'WrappedPlainView', 'ZoneView'
            ),
        117 => array (
        ...
        163 => array (
            'DTDHandler', 'DocumentHandler', 'EntityResolver', 'HandlerBase', 'InputSource', 'Locator', 'SAXException', 'SAXNotRecognizedException', 'SAXNotSupportedException', 'SAXParseException', 'XMLFilter', 'XMLReader'
            ),
        164 => array (
