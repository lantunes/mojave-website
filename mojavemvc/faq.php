...
an alternative DI container. Spring is a great framework, but if you
didn't want to use the Spring DI container, there were not many choices
of frameworks supporting both an alternative DI container, such as Guice,
...
to render JSPs, or as part of a RESTful service, where the content produced
